 ...
 * HttpServletRequest object and return list of FileItem. FileItem provides
 * useful method to get the file name, field name in form, size and content type
 * details of the file that needs to be uploaded. To write file to a directory,
 * all we need to do it create a File object and pass it as argument to FileItem
 * write() method.
 * 
